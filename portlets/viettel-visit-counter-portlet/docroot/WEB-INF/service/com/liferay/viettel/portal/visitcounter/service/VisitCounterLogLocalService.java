...
/**
 * Provides the local service interface for VisitCounterLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hiepth6
 * @see VisitCounterLogLocalServiceUtil
...
public interface VisitCounterLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VisitCounterLogLocalServiceUtil} to access the visit counter log local service. Add custom service methods to {@link com.liferay.viettel.portal.visitcounter.service.impl.VisitCounterLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
