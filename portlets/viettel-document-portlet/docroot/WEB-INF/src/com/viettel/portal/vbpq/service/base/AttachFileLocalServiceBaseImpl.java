...
import com.viettel.portal.vbpq.service.AttachFileLocalService;
...
/**
 * Provides the base implementation for the attach file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.portal.vbpq.service.impl.AttachFileLocalServiceImpl}.
 * </p>
 *
 * @author ChucHV
 ...
 * @generated
 */
public abstract class AttachFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AttachFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.portal.vbpq.service.AttachFileLocalServiceUtil} to access the attach file local service.
	 */
	...
	@Override
	public AttachFile addAttachFile(AttachFile attachFile)
		throws SystemException {
		attachFile.setNew(true);

		return attachFilePersistence.update(attachFile);
	}
	 ...
	 */
	@Override
	public AttachFile createAttachFile(long id) {
		return attachFilePersistence.create(id);
	}
	...
	@Override
	public AttachFile deleteAttachFile(long id)
		throws PortalException, SystemException {
		return attachFilePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AttachFile deleteAttachFile(AttachFile attachFile)
		throws SystemException {
		return attachFilePersistence.remove(attachFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AttachFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return attachFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return attachFilePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return attachFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AttachFile fetchAttachFile(long id) throws SystemException {
		return attachFilePersistence.fetchByPrimaryKey(id);
	}
	...
	public AttachFile getAttachFile(long id)
		throws PortalException, SystemException {
		return attachFilePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return attachFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AttachFile> getAttachFiles(int start, int end)
		throws SystemException {
		return attachFilePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAttachFilesCount() throws SystemException {
		return attachFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttachFile updateAttachFile(AttachFile attachFile)
		throws SystemException {
		return attachFilePersistence.update(attachFile);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.portal.vbpq.model.AttachFile",
			attachFileLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = attachFilePersistence.getDataSource();
	...
	private AttachFileLocalServiceClpInvoker _clpInvoker = new AttachFileLocalServiceClpInvoker();
}