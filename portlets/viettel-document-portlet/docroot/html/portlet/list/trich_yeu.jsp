...
%>
		...
		<%
			PortletURL readMoreURL = PortletURLFactoryUtil.create(request, "4_WAR_vietteldocumentportlet", selectlayoutId, PortletRequest.RENDER_PHASE);
			readMoreURL.setParameter("mvcPath", "/html/portlet/list/view.jsp");
			
			PortletURL rowURL1 = PortletURLFactoryUtil.create(request, "4_WAR_vietteldocumentportlet", selectlayoutId, PortletRequest.RENDER_PHASE);
	...
	/>     
		...
		>
		<%
			PortletURL rowURL = PortletURLFactoryUtil.create(request, "4_WAR_vietteldocumentportlet", selectlayoutId, PortletRequest.RENDER_PHASE);
	...
	<aui:script use="aui-base,node">
		var findEle = document.getElementById("_4_WAR_vietteldocumentportlet_vanBanPhapQuiesSearchContainer_col-trich-yeu");
		if (findEle != null) {
			A.one("#_4_WAR_vietteldocumentportlet_vanBanPhapQuiesSearchContainer_col-trich-yeu").hide();
		}
	</aui:script>
