...
import com.viettel.portal.staticasset.NoSuchFooException;
import com.viettel.portal.staticasset.model.Foo;
import com.viettel.portal.staticasset.model.impl.FooImpl;
import com.viettel.portal.staticasset.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	 ...
	 */
	@Override
	public Foo create(long id_) {
		Foo foo = new FooImpl();

		foo.setNew(true);
		foo.setPrimaryKey(id_);
	 ...
	 */
	@Override
	public Foo remove(long id_) throws NoSuchFooException, SystemException {
	...
	@Override
	public Foo updateImpl(com.viettel.portal.staticasset.model.Foo foo)
	 ...
	 */
	@Override
	public Foo findByPrimaryKey(long id_)
		throws NoSuchFooException, SystemException {
	 ...
	 */
	@Override
	public Foo fetchByPrimaryKey(long id_) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.viettel.portal.staticasset.model.Foo")));
