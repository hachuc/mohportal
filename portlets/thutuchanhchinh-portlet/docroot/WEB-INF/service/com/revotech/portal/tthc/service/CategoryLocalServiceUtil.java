 ...
 * {@link com.revotech.portal.tthc.service.impl.CategoryLocalServiceImpl} and is the
...
public class CategoryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.revotech.portal.tthc.service.impl.CategoryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.revotech.portal.tthc.model.Category addCategory(
	...
	*/
	public static com.revotech.portal.tthc.model.Category createCategory(
		long categoryId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.revotech.portal.tthc.model.Category deleteCategory(
		long categoryId)
	...
	*/
	...
	public static com.revotech.portal.tthc.model.Category fetchCategory(
		long categoryId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.revotech.portal.tthc.model.Category getCategory(
		long categoryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.revotech.portal.tthc.model.Category> getCategories(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.revotech.portal.tthc.model.Category updateCategory(
		com.revotech.portal.tthc.model.Category category)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static java.util.List<com.revotech.portal.tthc.model.Category> findByKeyword(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .findByKeyword(groupId, keyword, categoryType, start, end);
	}

	public static int countByKeyword(long groupId, java.lang.String keyword,
		int categoryType)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	public static java.util.List<com.revotech.portal.tthc.model.Category> getByCategoryType(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getByCategoryType(groupId, categoryType);
	}
	...
	public static java.util.List<com.revotech.portal.tthc.model.Category> getCategories(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getCategories(groupId, isActive, categoryType, start, end);
	}
	...
	public static java.util.List<com.revotech.portal.tthc.model.Category> findByCategoryName(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .findByCategoryName(groupId, categoryType, categoryName);
	}

	public static void addCategory(long groupId, long companyId, long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.addCategory(groupId, companyId, userId, userName, categoryName,
			categoryDesc, categoryType, catOrder, isActive, serviceContext);
	}

	public static void updateCategory(long groupId, long companyId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.updateCategory(groupId, companyId, userId, userName, categoryId,
			categoryName, categoryDesc, isActive, categoryType, catOrder,
			serviceContext);
	}
