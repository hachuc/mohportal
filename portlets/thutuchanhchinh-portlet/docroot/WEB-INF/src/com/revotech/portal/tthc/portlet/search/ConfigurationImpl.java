package com.revotech.portal.tthc.portlet.search;
...
public class ConfigurationImpl extends DefaultConfigurationAction{
	...
	public void processAction(PortletConfig portletConfig,
		...
		// TODO Auto-generated method stub
			try {
				...
				String displayStyle = ParamUtil.getString(actionRequest, "displayStyle","show-search");
	...
	public String render(PortletConfig portletConfig,
			...
			throws Exception {
		return "/html/view/search/config.jsp";
	}
