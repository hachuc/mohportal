...
<%
	...
	String portletTitle2 = portletPreferences.getValue("portletTitle2", StringPool.BLANK);
	...
	String job1Title = preferences.getValue("job1Title", "");
	String job2Title = preferences.getValue("job2Title", "");
	String job3Title = preferences.getValue("job3Title", "");
	Layout selectedLayout ;
	String url = "" ;
	if(layoutId > 0){
		selectedLayout = LayoutLocalServiceUtil.getLayout(layoutId);
		url = PortalUtil.getLayoutFriendlyURL(selectedLayout, themeDisplay);
	}	
%>