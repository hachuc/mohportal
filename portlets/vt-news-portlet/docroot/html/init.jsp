...
<%@page import="com.viettel.portal.newspublisher.util.NewsPublisherUtil"%>
...
<%
	...
	//Do dai tieu de
	int titleLength = GetterUtil.getInteger(portletPreferences.getValue("titleLength", null), 80);
	...
	// Hien thi ngay xuat ban
	boolean displayPublishedDate = GetterUtil.getBoolean(portletPreferences.getValue("displayPublishedDate", null), true);
	
	// Hien thi icon new
	boolean displayIconNew = GetterUtil.getBoolean(portletPreferences.getValue("displayIconNew", null), true);
	...
	AssetEntryQuery assetEntryQuery = NewsPublisherUtil.getAssetEntryQuery(portletPreferences, arrGroupIds, request);
