...
<%
	...
	for (int assetEntryIndex = 0; assetEntryIndex < results.size(); assetEntryIndex++) {
		...
		SimpleDateFormat dateFormatmonth = new SimpleDateFormat( "MMM dd");

		SimpleDateFormat dateFormatday = new SimpleDateFormat( "yyyy hh:mm");
...
<%!
	private static Log _log = LogFactoryUtil.getLog("html.display.title_summary_jsp");
%>