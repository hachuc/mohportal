...
long categorizableScopeId = scopeGroupId;

if(categorizableGroupIds != null && categorizableGroupIds.length > 0) {
	categorizableScopeId = categorizableGroupIds[0];
}

request.setAttribute("configuration.jsp-categorizableScopeId", categorizableScopeId);
%>
...
<div class="field-row form-inline query-row">
	...
	<div class="field tags-selector cnf-tags-selector">
		<liferay-ui:asset-tags-selector
			curTags='<%= HtmlUtil.escape(tagNameValues) %>'
