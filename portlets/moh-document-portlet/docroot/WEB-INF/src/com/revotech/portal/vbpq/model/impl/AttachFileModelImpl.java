...
import com.revotech.portal.vbpq.model.AttachFileModel;
...
/**
 * The base model implementation for the AttachFile service. Represents a row in the &quot;portal_attachfile&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.revotech.portal.vbpq.model.AttachFileModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AttachFileImpl}.
 * </p>
 *
 * @author ChucHV
 * @see AttachFileImpl
 * @see com.revotech.portal.vbpq.model.AttachFile
 * @see com.revotech.portal.vbpq.model.AttachFileModel
 * @generated
 */
public class AttachFileModelImpl extends BaseModelImpl<AttachFile>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a attach file model instance should use the {@link com.revotech.portal.vbpq.model.AttachFile} interface instead.
	 */
	public static final String TABLE_NAME = "portal_attachfile";
	...
	public static final String TABLE_SQL_CREATE = "create table portal_attachfile (ID LONG not null primary key,VANBANID LONG,FILEID LONG,FILELINK VARCHAR(255) null,FILENAME VARCHAR(255) null,FILESIZE VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table portal_attachfile";
	public static final String ORDER_BY_JPQL = " ORDER BY attachFile.id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY portal_attachfile.ID ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.revotech.portal.vbpq.model.AttachFile"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.revotech.portal.vbpq.model.AttachFile"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.revotech.portal.vbpq.model.AttachFile"),
			true);
	public static long VANBANID_COLUMN_BITMASK = 1L;
	public static long ID_COLUMN_BITMASK = 2L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.revotech.portal.vbpq.model.AttachFile"));
