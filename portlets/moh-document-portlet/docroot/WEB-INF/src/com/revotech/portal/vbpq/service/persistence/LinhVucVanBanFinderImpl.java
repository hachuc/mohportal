...
public class LinhVucVanBanFinderImpl extends BasePersistenceImpl<LinhVucVanBan>
		implements LinhVucVanBanFinder {
	
	public static final String FINDER_SQL = LinhVucVanBanFinder.class
			.getName() + ".finder";

	public static final String COUNT_SQL = LinhVucVanBanFinder.class
			.getName() + ".count";
	/**
	 * @param keyword
	 * @param groupId
	 ...
	 * @throws SystemException
	 */
	public List<LinhVucVanBan> find(String keyword, long groupId,
	 ...
	 * @throws SystemException
	 */
	private List<LinhVucVanBan> findBy_K(String[] keywords,
		...
		try {
			...
			q.addEntity("LinhVucVanBan", LinhVucVanBanImpl.class);
			...
			return (List<LinhVucVanBan>) QueryUtil.list(q, getDialect(),
					start, end);
	...
	private static final Log LOG = LogFactoryUtil
			.getLog(LinhVucVanBanFinderImpl.class);
