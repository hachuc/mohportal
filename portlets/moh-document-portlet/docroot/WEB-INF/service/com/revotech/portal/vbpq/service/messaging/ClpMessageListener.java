...
package com.revotech.portal.vbpq.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AttachFileLocalServiceUtil.clearService();

			CoQuanBanHanhVanBanLocalServiceUtil.clearService();

			LinhVucVanBanLocalServiceUtil.clearService();

			LoaiVanBanLocalServiceUtil.clearService();

			NhomVanBanLocalServiceUtil.clearService();

			VanBanPhapQuyLocalServiceUtil.clearService();
		}
	}
}