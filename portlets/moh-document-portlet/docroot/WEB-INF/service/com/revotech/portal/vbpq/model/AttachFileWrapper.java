...
public class AttachFileWrapper implements AttachFile, ModelWrapper<AttachFile> {
	...
	*/
	...
	@Override
	public int compareTo(com.revotech.portal.vbpq.model.AttachFile attachFile) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.revotech.portal.vbpq.model.AttachFile> toCacheModel() {
		return _attachFile.toCacheModel();
	}

	@Override
	public com.revotech.portal.vbpq.model.AttachFile toEscapedModel() {
		return new AttachFileWrapper(_attachFile.toEscapedModel());
	}

	@Override
	public com.revotech.portal.vbpq.model.AttachFile toUnescapedModel() {
