...
import com.revotech.portal.vbpq.service.ClpSerializer;
 ...
 * @author ChucHV
 */
public class CoQuanBanHanhVanBanClp extends BaseModelImpl<CoQuanBanHanhVanBan>
	implements CoQuanBanHanhVanBan {
	public CoQuanBanHanhVanBanClp() {
	}
	...
	public void setId(long id) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				Class<?> clazz = _coQuanBanHanhVanBanRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_coQuanBanHanhVanBanRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setTen(String ten) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, ten);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTrangThai(boolean trangThai) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, trangThai);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayTao(Date ngayTao) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, ngayTao);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgaySua(Date ngaySua) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, ngaySua);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNguoiTao(String nguoiTao) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, nguoiTao);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNguoiSua(String nguoiSua) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, nguoiSua);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGroupId(long groupId) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setOrder_(int order_) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				method.invoke(_coQuanBanHanhVanBanRemoteModel, order_);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNhomVanBanId(long nhomVanBanId) {
		...
		if (_coQuanBanHanhVanBanRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setNhomVanBanId", long.class);

				method.invoke(_coQuanBanHanhVanBanRemoteModel, nhomVanBanId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getCoQuanBanHanhVanBanRemoteModel() {
		return _coQuanBanHanhVanBanRemoteModel;
	}

	public void setCoQuanBanHanhVanBanRemoteModel(
		BaseModel<?> coQuanBanHanhVanBanRemoteModel) {
		_coQuanBanHanhVanBanRemoteModel = coQuanBanHanhVanBanRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _coQuanBanHanhVanBanRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_coQuanBanHanhVanBanRemoteModel,
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			CoQuanBanHanhVanBanLocalServiceUtil.addCoQuanBanHanhVanBan(this);
		}
		else {
			CoQuanBanHanhVanBanLocalServiceUtil.updateCoQuanBanHanhVanBan(this);
		}
	}

	@Override
	public CoQuanBanHanhVanBan toEscapedModel() {
		return (CoQuanBanHanhVanBan)ProxyUtil.newProxyInstance(CoQuanBanHanhVanBan.class.getClassLoader(),
			new Class[] { CoQuanBanHanhVanBan.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		CoQuanBanHanhVanBanClp clone = new CoQuanBanHanhVanBanClp();
		...
		clone.setNhomVanBanId(getNhomVanBanId());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CoQuanBanHanhVanBanClp)) {
			return false;
		}

		CoQuanBanHanhVanBanClp coQuanBanHanhVanBan = (CoQuanBanHanhVanBanClp)obj;
	...
	private BaseModel<?> _coQuanBanHanhVanBanRemoteModel;
	private Class<?> _clpSerializerClass = com.revotech.portal.vbpq.service.ClpSerializer.class;
}