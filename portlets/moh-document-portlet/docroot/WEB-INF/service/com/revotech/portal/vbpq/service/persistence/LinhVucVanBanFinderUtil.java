...
public class LinhVucVanBanFinderUtil {
	...
	public static java.util.List<com.revotech.portal.vbpq.model.LinhVucVanBan> find(
	...
	public static LinhVucVanBanFinder getFinder() {
		if (_finder == null) {
			_finder = (LinhVucVanBanFinder)PortletBeanLocatorUtil.locate(com.revotech.portal.vbpq.service.ClpSerializer.getServletContextName(),
