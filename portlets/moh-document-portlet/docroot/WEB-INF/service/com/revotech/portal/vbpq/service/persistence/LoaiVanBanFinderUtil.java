...
public class LoaiVanBanFinderUtil {
	...
	public static java.util.List<com.revotech.portal.vbpq.model.LoaiVanBan> find(
	...
	public static LoaiVanBanFinder getFinder() {
		if (_finder == null) {
			_finder = (LoaiVanBanFinder)PortletBeanLocatorUtil.locate(com.revotech.portal.vbpq.service.ClpSerializer.getServletContextName(),
