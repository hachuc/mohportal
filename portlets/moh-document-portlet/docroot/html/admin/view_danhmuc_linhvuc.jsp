...
<%
	String keyword = ParamUtil.getString(request, "keywords");
		 PortletURL iteratorURL = renderResponse.createRenderURL();
			iteratorURL.setParameter("mvcPath", "/html/admin/view_danhmuc_linhvuc.jsp");
%>
	...
	<aui:fieldset>
		...
		/>
			...
			<liferay-ui:search-container-row
	 			className="com.revotech.portal.vbpq.model.LinhVucVanBan"
				keyProperty="id"
				modelVar="linhvuc"
			>
				...
				<liferay-ui:search-container-column-text
					value="<%= HtmlUtil.escape(linhvuc.getTen()) %>"
					href="<%=rowURL %>"
				/>
				...
				<%
				try {
					NhomVanBan nv = NhomVanBanLocalServiceUtil.getNhomVanBan(linhvuc.getNhomVanBanId());
					if (nv != null) {
