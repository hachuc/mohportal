...
<%@page
	import="com.revotech.portal.vbpq.admin.business.LoaiVanBanBusiness"%>
<%@page
	import="com.revotech.portal.vbpq.admin.business.LinhVucVanBanBusiness"%>
<%@page
...
<%@page
	import="com.revotech.portal.vbpq.admin.business.VanBanPhapQuyBusiness"%>
...
<div class="post margin-left description">
			    <h2><a href=""><%= portletTitleTemp %></a></h2>
				<div class="search-result-vbpq table-responsive">
					<liferay-ui:search-container iteratorURL="<%= iteratorURL %>"
						...
						List<VanBanPhapQuy> lst = grid.getList();
						if(lst!= null && lst.size()>0){
							grid.getList();
							for(int i=0;i < lst.size() ;i++){
								VanBanPhapQuy vanban = lst.get(i);
					%>
								<liferay-portlet:renderURL var="rowURL" portletName="<%= WebKeys.VBPQ_PORTLET_NAME%>">
								...
								<li><a href="<%= rowURL %>"><%= HtmlUtil.escape(vanban.getTrichYeu()) %></a></li>
						<% }}%>
						</ul>
