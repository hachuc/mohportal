...
<%
	...
	String videoLibraryPortletResource = "2_WAR_revotechmediaportlet";
	...
	String templatePath = ParamUtil.getString(request, "template-path");
%>

<portlet:renderURL var="frontendHomePageURL" windowState="<%=LiferayWindowState.NORMAL.toString() %>">
