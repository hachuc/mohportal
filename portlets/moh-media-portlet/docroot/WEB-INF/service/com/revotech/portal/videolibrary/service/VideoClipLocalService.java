...
/**
 * Provides the local service interface for VideoClip. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ChucHV
 * @see VideoClipLocalServiceUtil
...
public interface VideoClipLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VideoClipLocalServiceUtil} to access the video clip local service. Add custom service methods to {@link com.revotech.portal.videolibrary.service.impl.VideoClipLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
