...
public class VideoUserNameComparator extends OrderByComparator {
	...
	public static final String ORDER_BY_ASC = "portal_video.username ASC";

	public static final String ORDER_BY_DESC = "portal_video.username DESC";
	...
	public int compare(Object obj1, Object obj2) {
		...
		int value = video1.getUserName().toLowerCase()
				.compareTo(video2.getUserName().toLowerCase());
