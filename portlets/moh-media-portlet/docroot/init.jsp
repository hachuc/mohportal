...
long selectedImageFolderId = GetterUtil.getLong(portletPreferences.getValue("selectedImageFolderId", String.valueOf(DLFolderConstants.DEFAULT_PARENT_FOLDER_ID)));

//So luong anh hien thi.Mac dinh la tat ca anh co trong thu muc duoc chon.
int numbersOfImageDisplay = GetterUtil.getInteger(portletPreferences.getValue("numbersOfImageDisplay","5"));

//Su dung anh nho (thumbnail) de hien thi
boolean useThumbnailImage = GetterUtil.getBoolean(portletPreferences.getValue("useThumbnailImage", "true"));

//Hien thi kich thuoc anh tuy chon
boolean useCustomImageSize = GetterUtil.getBoolean(portletPreferences.getValue("useCustomImageSize", "false"));

//Chieu dai anh thumbnail mac dinh cua file anh tren thu vien
int imageThumbnailWidth = GetterUtil.getInteger(portletPreferences.getValue("imageThumbnailWidth","260"));

//Chieu rong anh thumbnail mac dinh cua file anh tren thu vien
int imageThumbnailHeight = GetterUtil.getInteger(portletPreferences.getValue("imageThumbnailHeight","140"));

//Hien thi link den trang Gallery
boolean displayGalleryLink = GetterUtil.getBoolean(portletPreferences.getValue("displayGalleryLink", "true"));

//Id cua Page hien thi Gallery
long galleryPageId = GetterUtil.getLong(portletPreferences.getValue("galleryPageId", String.valueOf(themeDisplay.getPlid())));
%>
