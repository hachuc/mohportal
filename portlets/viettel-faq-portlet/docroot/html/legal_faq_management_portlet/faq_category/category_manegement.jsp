...
<%
	...
	List<LegalFAQCategory> faqCategoryList = LegalFAQCategoryLocalServiceUtil.findByKeyword(scopeGroupId, 1, faqCategorySearchKeyword, 0, -1);
	...
	<c:if test='<%=Validator.equals(categoryCommand, "updateCategory")%>'>
		<div class="faq_category_update_form" align="center">
			<aui:form name="faq_category_update_form"  method="post" action="<%=updateFAQCategoryURL%>">
				<aui:input type="hidden" name="categoryType" value="1" />
				<br/>
				<table>
					<tr>
