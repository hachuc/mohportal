...
<div class="faq_entry_list">
	...
	<liferay-ui:search-container emptyResultsMessage="<%=emptyResultMessageKey %>"
	...
	>
		...
		<liferay-ui:search-container-results results="<%=searchResultList%>" total="<%=searchResultList.size() %>" />			
		...
		<liferay-ui:search-container-row className="LegalFAQEntry" keyProperty="entryId" modelVar="faqEntry"  escapedModel="<%=true %>">
			...
			<liferay-ui:search-container-column-text name="content-title" 
				value="<%= faqEntry.getCitizenPhone() %>" 
				orderable="<%=true %>"
				orderableProperty="ask-phone"
				href="<%=rowHREF %>"
			/>
			<liferay-ui:search-container-column-text name="full-name" 
				value="<%= faqEntry.getCitizenName() %>" 
				orderable="<%=true %>"
				orderableProperty="full-name"
				href="<%=rowHREF %>"
			/>
			<liferay-ui:search-container-column-text name="ask-address" 
