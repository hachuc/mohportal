...
/**
 * Provides the local service utility for LegalFAQCategory. This utility wraps
 * {@link com.portal_egov.portlet.legal_faq.service.impl.LegalFAQCategoryLocalServiceImpl} and is the
...
public class LegalFAQCategoryLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQCategory> findByKeyword(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByKeyword(groupId, type, keyword, start, end);
	}
	...
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQCategory> getCategoryByType(
		int type, long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCategoryByType(type, groupId);
	}
	...
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQCategory addCategory(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addCategory(companyId, groupId, type, userId, parentId,
	...
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQCategory updateCategory(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateCategory(categoryId, companyId, groupId, type,
			userId, parentId, categoryName, categoryDesc);
	}
