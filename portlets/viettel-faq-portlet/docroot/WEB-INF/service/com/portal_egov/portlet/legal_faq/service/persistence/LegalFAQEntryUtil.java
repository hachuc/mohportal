...
public class LegalFAQEntryUtil {
	...
	public static LegalFAQEntry update(LegalFAQEntry legalFAQEntry)
		throws SystemException {
		return getPersistence().update(legalFAQEntry);
	}
	...
	public static LegalFAQEntry update(LegalFAQEntry legalFAQEntry,
		...
		return getPersistence().update(legalFAQEntry, serviceContext);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQEntry> findByGroupStatusEntryId(
		long groupId, int publishStatus, int status, int viewCount)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByGroupStatusEntryId(groupId, publishStatus, status,
			viewCount);
	}
	...
	*/
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQEntry> findByGroupStatusEntryId(
		long groupId, int publishStatus, int status, int viewCount, int start,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry findByGroupStatusEntryId_First(
		long groupId, int publishStatus, int status, int viewCount,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.portal_egov.portlet.legal_faq.NoSuchLegalFAQEntryException {
		return getPersistence()
				   .findByGroupStatusEntryId_First(groupId, publishStatus,
			status, viewCount, orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry fetchByGroupStatusEntryId_First(
		long groupId, int publishStatus, int status, int viewCount,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByGroupStatusEntryId_First(groupId, publishStatus,
			status, viewCount, orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry findByGroupStatusEntryId_Last(
		long groupId, int publishStatus, int status, int viewCount,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.portal_egov.portlet.legal_faq.NoSuchLegalFAQEntryException {
		return getPersistence()
				   .findByGroupStatusEntryId_Last(groupId, publishStatus,
			status, viewCount, orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry fetchByGroupStatusEntryId_Last(
		long groupId, int publishStatus, int status, int viewCount,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByGroupStatusEntryId_Last(groupId, publishStatus,
			status, viewCount, orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry[] findByGroupStatusEntryId_PrevAndNext(
		long entryId, long groupId, int publishStatus, int status,
		int viewCount,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.portal_egov.portlet.legal_faq.NoSuchLegalFAQEntryException {
		return getPersistence()
				   .findByGroupStatusEntryId_PrevAndNext(entryId, groupId,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQEntry> filterFindByGroupStatusEntryId(
		long groupId, int publishStatus, int status, int viewCount)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .filterFindByGroupStatusEntryId(groupId, publishStatus,
			status, viewCount);
	}
	...
	*/
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQEntry> filterFindByGroupStatusEntryId(
		...
		return getPersistence()
				   .filterFindByGroupStatusEntryId(groupId, publishStatus,
			status, viewCount, start, end, orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry[] filterFindByGroupStatusEntryId_PrevAndNext(
		long entryId, long groupId, int publishStatus, int status,
		int viewCount,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.portal_egov.portlet.legal_faq.NoSuchLegalFAQEntryException {
		return getPersistence()
				   .filterFindByGroupStatusEntryId_PrevAndNext(entryId,
			groupId, publishStatus, status, viewCount, orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void removeByGroupStatusEntryId(long groupId,
		int publishStatus, int status, int viewCount)
		throws com.liferay.portal.kernel.exception.SystemException {
		getPersistence()
			.removeByGroupStatusEntryId(groupId, publishStatus, status,
			viewCount);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int countByGroupStatusEntryId(long groupId,
		int publishStatus, int status, int viewCount)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .countByGroupStatusEntryId(groupId, publishStatus, status,
			viewCount);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int filterCountByGroupStatusEntryId(long groupId,
		int publishStatus, int status, int viewCount)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .filterCountByGroupStatusEntryId(groupId, publishStatus,
			status, viewCount);
	}
	...
	*/
	...
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry updateImpl(
		com.portal_egov.portlet.legal_faq.model.LegalFAQEntry legalFAQEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(legalFAQEntry);
	}
