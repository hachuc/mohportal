...
/**
 * Provides the local service utility for LegalFAQEntry. This utility wraps
 * {@link com.portal_egov.portlet.legal_faq.service.impl.LegalFAQEntryLocalServiceImpl} and is the
...
public class LegalFAQEntryLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.portal_egov.portlet.legal_faq.model.LegalFAQEntry> findByGroupStatusEntryId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByGroupStatusEntryId(groupId, entryId);
	}
	...
	public static com.portal_egov.portlet.legal_faq.model.LegalFAQEntry addFAQEntry(
		...
		return getService()
			...
			citizenName, citizenPhone, citizenEmail, askDate, askTitle,
			askContent, answerDate, answerContent, assetEntryId, publishStatus,
