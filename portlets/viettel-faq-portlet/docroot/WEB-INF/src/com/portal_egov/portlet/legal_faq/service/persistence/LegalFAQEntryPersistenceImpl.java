...
public class LegalFAQEntryPersistenceImpl extends BasePersistenceImpl<LegalFAQEntry>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANY =
		new FinderPath(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
			...
			LegalFAQEntryModelImpl.PUBLISHDATE_COLUMN_BITMASK);
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					...
					list = new UnmodifiableList<LegalFAQEntry>(list);
				}
				else {
					list = (List<LegalFAQEntry>)QueryUtil.list(q, getDialect(),
							start, end);
	...
	public void removeByCategoryAndStatus(long groupId, long categoryId,
		...
		for (LegalFAQEntry legalFAQEntry : findByCategoryAndStatus(groupId,
				categoryId, publishStatus, status, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(legalFAQEntry);
		}
	}
	...
	public int countByCategoryAndStatus(long groupId, long categoryId,
		int publishStatus, int status) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_CATEGORYANDSTATUS;
	...
	public void removeByCompanyAndStatus(long companyId, int publishStatus,
		...
		for (LegalFAQEntry legalFAQEntry : findByCompanyAndStatus(companyId,
				publishStatus, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(legalFAQEntry);
		}
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPSTATUSENTRYID =
		new FinderPath(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
			LegalFAQEntryModelImpl.FINDER_CACHE_ENABLED,
			LegalFAQEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupStatusEntryId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPSTATUSENTRYID =
		new FinderPath(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
			LegalFAQEntryModelImpl.FINDER_CACHE_ENABLED,
			LegalFAQEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByGroupStatusEntryId",
			...
			LegalFAQEntryModelImpl.PUBLISHSTATUS_COLUMN_BITMASK |
			LegalFAQEntryModelImpl.STATUS_COLUMN_BITMASK |
			LegalFAQEntryModelImpl.VIEWCOUNT_COLUMN_BITMASK |
			LegalFAQEntryModelImpl.PUBLISHDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPSTATUSENTRYID = new FinderPath(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
			LegalFAQEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGroupStatusEntryId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName()
			});
	...
	/**
	 * Returns all the legal f a q entries where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public List<LegalFAQEntry> findByGroupStatusEntryId(long groupId,
		int publishStatus, int status, int viewCount) throws SystemException {
		return findByGroupStatusEntryId(groupId, publishStatus, status,
			viewCount, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the legal f a q entries where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<LegalFAQEntry> findByGroupStatusEntryId(long groupId,
		int publishStatus, int status, int viewCount, int start, int end)
		throws SystemException {
		return findByGroupStatusEntryId(groupId, publishStatus, status,
			viewCount, start, end, null);
	}

	/**
	 * Returns an ordered range of all the legal f a q entries where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<LegalFAQEntry> findByGroupStatusEntryId(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPSTATUSENTRYID;
			finderArgs = new Object[] { groupId, publishStatus, status, viewCount };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPSTATUSENTRYID;
			finderArgs = new Object[] {
					groupId, publishStatus, status, viewCount,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LegalFAQEntry legalFAQEntry : list) {
				if ((groupId != legalFAQEntry.getGroupId()) ||
						(publishStatus != legalFAQEntry.getPublishStatus()) ||
						(status != legalFAQEntry.getStatus()) ||
						(viewCount != legalFAQEntry.getViewCount())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_GROUPSTATUSENTRYID_GROUPID_2);

			query.append(_FINDER_COLUMN_GROUPSTATUSENTRYID_PUBLISHSTATUS_2);

			query.append(_FINDER_COLUMN_GROUPSTATUSENTRYID_STATUS_2);

			query.append(_FINDER_COLUMN_GROUPSTATUSENTRYID_VIEWCOUNT_2);
	...
	/**
	 * Returns the first legal f a q entry in the ordered set where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public LegalFAQEntry findByGroupStatusEntryId_First(long groupId,
		int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator)
		throws NoSuchLegalFAQEntryException, SystemException {
		LegalFAQEntry legalFAQEntry = fetchByGroupStatusEntryId_First(groupId,
				publishStatus, status, viewCount, orderByComparator);
	 ...
	 */
	@Override
	public LegalFAQEntry fetchByGroupStatusEntryId_First(long groupId,
		int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator) throws SystemException {
		List<LegalFAQEntry> list = findByGroupStatusEntryId(groupId,
				publishStatus, status, viewCount, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last legal f a q entry in the ordered set where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public LegalFAQEntry findByGroupStatusEntryId_Last(long groupId,
		int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator)
		throws NoSuchLegalFAQEntryException, SystemException {
		LegalFAQEntry legalFAQEntry = fetchByGroupStatusEntryId_Last(groupId,
				publishStatus, status, viewCount, orderByComparator);
	 ...
	 */
	@Override
	public LegalFAQEntry fetchByGroupStatusEntryId_Last(long groupId,
		int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByGroupStatusEntryId(groupId, publishStatus, status,
				viewCount);
		...
		List<LegalFAQEntry> list = findByGroupStatusEntryId(groupId,
				publishStatus, status, viewCount, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the legal f a q entries before and after the current legal f a q entry in the ordered set where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param entryId the primary key of the current legal f a q entry
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 ...
	 */
	@Override
	public LegalFAQEntry[] findByGroupStatusEntryId_PrevAndNext(long entryId,
		long groupId, int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator)
		throws NoSuchLegalFAQEntryException, SystemException {
		LegalFAQEntry legalFAQEntry = findByPrimaryKey(entryId);
		...
		try {
			...
			array[0] = getByGroupStatusEntryId_PrevAndNext(session,
					legalFAQEntry, groupId, publishStatus, status, viewCount,
					orderByComparator, true);

			array[1] = legalFAQEntry;

			array[2] = getByGroupStatusEntryId_PrevAndNext(session,
					legalFAQEntry, groupId, publishStatus, status, viewCount,
					orderByComparator, false);
	...
	protected LegalFAQEntry getByGroupStatusEntryId_PrevAndNext(
		Session session, LegalFAQEntry legalFAQEntry, long groupId,
		int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the legal f a q entries that the user has permission to view where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public List<LegalFAQEntry> filterFindByGroupStatusEntryId(long groupId,
		int publishStatus, int status, int viewCount) throws SystemException {
		return filterFindByGroupStatusEntryId(groupId, publishStatus, status,
			viewCount, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the legal f a q entries that the user has permission to view where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the legal f a q entries that the user has permissions to view where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<LegalFAQEntry> filterFindByGroupStatusEntryId(long groupId,
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupStatusEntryId(groupId, publishStatus, status,
				viewCount, start, end, orderByComparator);
		}
	...
	/**
	 * Returns the legal f a q entries before and after the current legal f a q entry in the ordered set of legal f a q entries that the user has permission to view where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param entryId the primary key of the current legal f a q entry
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 ...
	 */
	@Override
	public LegalFAQEntry[] filterFindByGroupStatusEntryId_PrevAndNext(
		long entryId, long groupId, int publishStatus, int status,
		int viewCount, OrderByComparator orderByComparator)
		throws NoSuchLegalFAQEntryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupStatusEntryId_PrevAndNext(entryId, groupId,
				publishStatus, status, viewCount, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupStatusEntryId_PrevAndNext(session,
					legalFAQEntry, groupId, publishStatus, status, viewCount,
					orderByComparator, true);

			array[1] = legalFAQEntry;

			array[2] = filterGetByGroupStatusEntryId_PrevAndNext(session,
					legalFAQEntry, groupId, publishStatus, status, viewCount,
					orderByComparator, false);
	...
	protected LegalFAQEntry filterGetByGroupStatusEntryId_PrevAndNext(
		Session session, LegalFAQEntry legalFAQEntry, long groupId,
		int publishStatus, int status, int viewCount,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the legal f a q entries where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public void removeByGroupStatusEntryId(long groupId, int publishStatus,
		int status, int viewCount) throws SystemException {
		for (LegalFAQEntry legalFAQEntry : findByGroupStatusEntryId(groupId,
				publishStatus, status, viewCount, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(legalFAQEntry);
		}
	}
	...
	/**
	 * Returns the number of legal f a q entries where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public int countByGroupStatusEntryId(long groupId, int publishStatus,
		int status, int viewCount) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_GROUPSTATUSENTRYID;
	...
	/**
	 * Returns the number of legal f a q entries that the user has permission to view where groupId = &#63; and publishStatus = &#63; and status = &#63; and viewCount = &#63;.
	 *
	 * @param groupId the group ID
	 * @param publishStatus the publish status
	 * @param status the status
	 ...
	 */
	@Override
	public int filterCountByGroupStatusEntryId(long groupId, int publishStatus,
		int status, int viewCount) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByGroupStatusEntryId(groupId, publishStatus, status,
				viewCount);
		}
	...
	private static final String _FINDER_COLUMN_GROUPSTATUSENTRYID_GROUPID_2 = "legalFAQEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPSTATUSENTRYID_PUBLISHSTATUS_2 =
		"legalFAQEntry.publishStatus = ? AND ";
	private static final String _FINDER_COLUMN_GROUPSTATUSENTRYID_STATUS_2 = "legalFAQEntry.status = ? AND ";
	private static final String _FINDER_COLUMN_GROUPSTATUSENTRYID_VIEWCOUNT_2 = "legalFAQEntry.viewCount = ?";
	...
	public void removeByPublishStatus(long groupId, int publishStatus)
		...
		for (LegalFAQEntry legalFAQEntry : findByPublishStatus(groupId,
				publishStatus, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(legalFAQEntry);
		}
	}
	...
	public LegalFAQEntryPersistenceImpl() {
		setModelClass(LegalFAQEntry.class);
	}
	...
	protected LegalFAQEntry removeImpl(LegalFAQEntry legalFAQEntry)
		...
		try {
			...
			if (!session.contains(legalFAQEntry)) {
				legalFAQEntry = (LegalFAQEntry)session.get(LegalFAQEntryImpl.class,
						legalFAQEntry.getPrimaryKeyObj());
			}

			if (legalFAQEntry != null) {
				session.delete(legalFAQEntry);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	public LegalFAQEntry updateImpl(
		...
		try {
			...
			if (legalFAQEntry.isNew()) {
				session.save(legalFAQEntry);

				legalFAQEntry.setNew(false);
			}
			else {
				session.merge(legalFAQEntry);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (isNew || !LegalFAQEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((legalFAQEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQEntryModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] { legalFAQEntryModelImpl.getCompanyId() };
			...
			if ((legalFAQEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQEntryModelImpl.getOriginalGroupId()
					};
				...
				args = new Object[] { legalFAQEntryModelImpl.getGroupId() };
			...
			if ((legalFAQEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQEntryModelImpl.getOriginalGroupId(),
						legalFAQEntryModelImpl.getOriginalCategoryId()
					};
				...
				args = new Object[] {
						legalFAQEntryModelImpl.getGroupId(),
						legalFAQEntryModelImpl.getCategoryId()
					};
			...
			if ((legalFAQEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQEntryModelImpl.getOriginalGroupId(),
						legalFAQEntryModelImpl.getOriginalCategoryId(),
						legalFAQEntryModelImpl.getOriginalPublishStatus(),
						legalFAQEntryModelImpl.getOriginalStatus()
					};
				...
				args = new Object[] {
						legalFAQEntryModelImpl.getGroupId(),
						legalFAQEntryModelImpl.getCategoryId(),
						legalFAQEntryModelImpl.getPublishStatus(),
						legalFAQEntryModelImpl.getStatus()
					};
			...
			if ((legalFAQEntryModelImpl.getColumnBitmask() &
				...
				args = new Object[] {
						legalFAQEntryModelImpl.getCompanyId(),
						legalFAQEntryModelImpl.getPublishStatus(),
						legalFAQEntryModelImpl.getStatus()
					};
			...
			if ((legalFAQEntryModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPSTATUSENTRYID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						legalFAQEntryModelImpl.getOriginalGroupId(),
						legalFAQEntryModelImpl.getOriginalPublishStatus(),
						legalFAQEntryModelImpl.getOriginalStatus(),
						legalFAQEntryModelImpl.getOriginalViewCount()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_GROUPSTATUSENTRYID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPSTATUSENTRYID,
					args);
				...
				args = new Object[] {
						...
						legalFAQEntryModelImpl.getPublishStatus(),
						legalFAQEntryModelImpl.getStatus(),
						legalFAQEntryModelImpl.getViewCount()
					};
	...
	public LegalFAQEntry findByPrimaryKey(Serializable primaryKey)
		throws NoSuchLegalFAQEntryException, SystemException {
		LegalFAQEntry legalFAQEntry = fetchByPrimaryKey(primaryKey);
	...
	public LegalFAQEntry fetchByPrimaryKey(Serializable primaryKey)
		...
		LegalFAQEntry legalFAQEntry = (LegalFAQEntry)EntityCacheUtil.getResult(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
				LegalFAQEntryImpl.class, primaryKey);
		...
		if (legalFAQEntry == null) {
			...
			try {
				...
				if (legalFAQEntry != null) {
					...
					EntityCacheUtil.putResult(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
						LegalFAQEntryImpl.class, primaryKey, _nullLegalFAQEntry);
				}
			}
			catch (Exception e) {
				EntityCacheUtil.removeResult(LegalFAQEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public List<LegalFAQEntry> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_LEGALFAQENTRY;

				if (pagination) {
					sql = sql.concat(LegalFAQEntryModelImpl.ORDER_BY_JPQL);
				}
			}
