...
public class LegalFAQCategoryPersistenceImpl extends BasePersistenceImpl<LegalFAQCategory>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANY =
		new FinderPath(LegalFAQCategoryModelImpl.ENTITY_CACHE_ENABLED,
			...
			LegalFAQCategoryModelImpl.CATEGORYNAME_COLUMN_BITMASK);
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					...
					list = new UnmodifiableList<LegalFAQCategory>(list);
				}
				else {
					list = (List<LegalFAQCategory>)QueryUtil.list(q,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_BYTYPE = new FinderPath(LegalFAQCategoryModelImpl.ENTITY_CACHE_ENABLED,
			LegalFAQCategoryModelImpl.FINDER_CACHE_ENABLED,
			LegalFAQCategoryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findBybyType",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BYTYPE =
		new FinderPath(LegalFAQCategoryModelImpl.ENTITY_CACHE_ENABLED,
			...
			LegalFAQCategoryModelImpl.CATEGORYTYPE_COLUMN_BITMASK |
			LegalFAQCategoryModelImpl.GROUPID_COLUMN_BITMASK |
			LegalFAQCategoryModelImpl.CATEGORYNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_BYTYPE = new FinderPath(LegalFAQCategoryModelImpl.ENTITY_CACHE_ENABLED,
			LegalFAQCategoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBybyType",
			new String[] { Integer.class.getName(), Long.class.getName() });

	/**
	 * Returns all the legal f a q categories where categoryType = &#63; and groupId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<LegalFAQCategory> findBybyType(int categoryType, long groupId)
		throws SystemException {
		return findBybyType(categoryType, groupId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the legal f a q categories where categoryType = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<LegalFAQCategory> findBybyType(int categoryType, long groupId,
		...
		return findBybyType(categoryType, groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the legal f a q categories where categoryType = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<LegalFAQCategory> findBybyType(int categoryType, long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { categoryType, groupId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_BYTYPE;
			finderArgs = new Object[] {
					categoryType, groupId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LegalFAQCategory legalFAQCategory : list) {
				if ((categoryType != legalFAQCategory.getCategoryType()) ||
						(groupId != legalFAQCategory.getGroupId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_BYTYPE_CATEGORYTYPE_2);

			query.append(_FINDER_COLUMN_BYTYPE_GROUPID_2);
	...
	/**
	 * Returns the first legal f a q category in the ordered set where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryType the category type
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public LegalFAQCategory findBybyType_First(int categoryType, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchLegalFAQCategoryException, SystemException {
		LegalFAQCategory legalFAQCategory = fetchBybyType_First(categoryType,
	 ...
	 */
	@Override
	public LegalFAQCategory fetchBybyType_First(int categoryType, long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<LegalFAQCategory> list = findBybyType(categoryType, groupId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last legal f a q category in the ordered set where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryType the category type
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public LegalFAQCategory findBybyType_Last(int categoryType, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchLegalFAQCategoryException, SystemException {
		LegalFAQCategory legalFAQCategory = fetchBybyType_Last(categoryType,
				groupId, orderByComparator);
	 ...
	 */
	@Override
	public LegalFAQCategory fetchBybyType_Last(int categoryType, long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countBybyType(categoryType, groupId);

		if (count == 0) {
			return null;
		}

		List<LegalFAQCategory> list = findBybyType(categoryType, groupId,
	...
	/**
	 * Returns the legal f a q categories before and after the current legal f a q category in the ordered set where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryId the primary key of the current legal f a q category
	 * @param categoryType the category type
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public LegalFAQCategory[] findBybyType_PrevAndNext(long categoryId,
		int categoryType, long groupId, OrderByComparator orderByComparator)
		throws NoSuchLegalFAQCategoryException, SystemException {
		LegalFAQCategory legalFAQCategory = findByPrimaryKey(categoryId);
		...
		try {
			...
			array[0] = getBybyType_PrevAndNext(session, legalFAQCategory,
					categoryType, groupId, orderByComparator, true);

			array[1] = legalFAQCategory;

			array[2] = getBybyType_PrevAndNext(session, legalFAQCategory,
					categoryType, groupId, orderByComparator, false);
	...
	protected LegalFAQCategory getBybyType_PrevAndNext(Session session,
		LegalFAQCategory legalFAQCategory, int categoryType, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the legal f a q categories that the user has permission to view where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryType the category type
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<LegalFAQCategory> filterFindBybyType(int categoryType,
		long groupId) throws SystemException {
		return filterFindBybyType(categoryType, groupId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the legal f a q categories that the user has permission to view where categoryType = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<LegalFAQCategory> filterFindBybyType(int categoryType,
		...
		return filterFindBybyType(categoryType, groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the legal f a q categories that the user has permissions to view where categoryType = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.portal_egov.portlet.legal_faq.model.impl.LegalFAQCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<LegalFAQCategory> filterFindBybyType(int categoryType,
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findBybyType(categoryType, groupId, start, end,
				orderByComparator);
		}
	...
	/**
	 * Returns the legal f a q categories before and after the current legal f a q category in the ordered set of legal f a q categories that the user has permission to view where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryId the primary key of the current legal f a q category
	 * @param categoryType the category type
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public LegalFAQCategory[] filterFindBybyType_PrevAndNext(long categoryId,
		int categoryType, long groupId, OrderByComparator orderByComparator)
		throws NoSuchLegalFAQCategoryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findBybyType_PrevAndNext(categoryId, categoryType, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetBybyType_PrevAndNext(session, legalFAQCategory,
					categoryType, groupId, orderByComparator, true);

			array[1] = legalFAQCategory;

			array[2] = filterGetBybyType_PrevAndNext(session, legalFAQCategory,
					categoryType, groupId, orderByComparator, false);
	...
	protected LegalFAQCategory filterGetBybyType_PrevAndNext(Session session,
		LegalFAQCategory legalFAQCategory, int categoryType, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the legal f a q categories where categoryType = &#63; and groupId = &#63; from the database.
	 *
	 * @param categoryType the category type
	 * @param groupId the group ID
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public void removeBybyType(int categoryType, long groupId)
		throws SystemException {
		for (LegalFAQCategory legalFAQCategory : findBybyType(categoryType,
	...
	/**
	 * Returns the number of legal f a q categories where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryType the category type
	 * @param groupId the group ID
	 * @return the number of matching legal f a q categories
	 ...
	 */
	@Override
	public int countBybyType(int categoryType, long groupId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_BYTYPE;

		Object[] finderArgs = new Object[] { categoryType, groupId };
	...
	/**
	 * Returns the number of legal f a q categories that the user has permission to view where categoryType = &#63; and groupId = &#63;.
	 *
	 * @param categoryType the category type
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public int filterCountBybyType(int categoryType, long groupId)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countBybyType(categoryType, groupId);
		}
	...
	private static final String _FINDER_COLUMN_BYTYPE_CATEGORYTYPE_2 = "legalFAQCategory.categoryType = ? AND ";
	private static final String _FINDER_COLUMN_BYTYPE_GROUPID_2 = "legalFAQCategory.groupId = ?";
	...
	public LegalFAQCategoryPersistenceImpl() {
		setModelClass(LegalFAQCategory.class);
	}
	...
	protected LegalFAQCategory removeImpl(LegalFAQCategory legalFAQCategory)
		...
		try {
			...
			if (!session.contains(legalFAQCategory)) {
				legalFAQCategory = (LegalFAQCategory)session.get(LegalFAQCategoryImpl.class,
						legalFAQCategory.getPrimaryKeyObj());
			}

			if (legalFAQCategory != null) {
				session.delete(legalFAQCategory);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	public LegalFAQCategory updateImpl(
		...
		try {
			...
			if (legalFAQCategory.isNew()) {
				session.save(legalFAQCategory);

				legalFAQCategory.setNew(false);
			}
			else {
				session.merge(legalFAQCategory);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (isNew || !LegalFAQCategoryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((legalFAQCategoryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQCategoryModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] { legalFAQCategoryModelImpl.getCompanyId() };
			...
			if ((legalFAQCategoryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQCategoryModelImpl.getOriginalCategoryType(),
						legalFAQCategoryModelImpl.getOriginalGroupId()
					};
				...
				args = new Object[] {
						legalFAQCategoryModelImpl.getCategoryType(),
						legalFAQCategoryModelImpl.getGroupId()
					};
			...
			if ((legalFAQCategoryModelImpl.getColumnBitmask() &
				...
				args = new Object[] { legalFAQCategoryModelImpl.getGroupId() };
			...
			if ((legalFAQCategoryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						legalFAQCategoryModelImpl.getOriginalCompanyId(),
						legalFAQCategoryModelImpl.getOriginalParentId()
					};
				...
				args = new Object[] {
						legalFAQCategoryModelImpl.getCompanyId(),
						legalFAQCategoryModelImpl.getParentId()
					};
	...
	protected LegalFAQCategory toUnwrappedModel(
		...
		legalFAQCategoryImpl.setCategoryType(legalFAQCategory.getCategoryType());
	...
	public LegalFAQCategory findByPrimaryKey(Serializable primaryKey)
		throws NoSuchLegalFAQCategoryException, SystemException {
		LegalFAQCategory legalFAQCategory = fetchByPrimaryKey(primaryKey);
	...
	public LegalFAQCategory fetchByPrimaryKey(Serializable primaryKey)
		...
		LegalFAQCategory legalFAQCategory = (LegalFAQCategory)EntityCacheUtil.getResult(LegalFAQCategoryModelImpl.ENTITY_CACHE_ENABLED,
				LegalFAQCategoryImpl.class, primaryKey);
	...
	public List<LegalFAQCategory> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_LEGALFAQCATEGORY;

				if (pagination) {
					sql = sql.concat(LegalFAQCategoryModelImpl.ORDER_BY_JPQL);
				}
			}
