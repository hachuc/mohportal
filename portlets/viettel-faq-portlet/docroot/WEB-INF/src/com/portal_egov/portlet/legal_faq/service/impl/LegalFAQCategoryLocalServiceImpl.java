...
public class LegalFAQCategoryLocalServiceImpl extends LegalFAQCategoryLocalServiceBaseImpl {
	...
	public List<LegalFAQCategory> findByKeyword(long groupId, int type, String keyword,int start,int end) throws SystemException{
		return LegalFAQCategoryFinderUtil.findByKeyword(groupId, type, keyword, start, end);
	}
	...
	public List<LegalFAQCategory> getCategoryByType(int type, long groupId) throws SystemException{
		return legalFAQCategoryPersistence.findBybyType(type, groupId);
	}
	public LegalFAQCategory addCategory(long companyId,long groupId, int type, long userId,long parentId,String categoryName,
		...
		legalFAQCategory.setCategoryType(type);
	...
	public LegalFAQCategory updateCategory(long categoryId,long companyId,long groupId,int type, long userId,long parentId,String categoryName,
