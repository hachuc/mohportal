...
public class LegalFAQEntryLocalServiceImpl extends LegalFAQEntryLocalServiceBaseImpl {
	private static Log _log = LogFactory.getLog(LegalFAQEntryLocalServiceImpl.class.getName());
	...
	public List<LegalFAQEntry> findByGroupStatusEntryId(long groupId,int entryId) throws SystemException{
		return legalFAQEntryPersistence.findByGroupStatusEntryId(groupId, 1, 1, entryId);
	}
	...
	public LegalFAQEntry addFAQEntry(long companyId,long groupId,long userId,long categoryId,String citizenName,String citizenPhone,
			String citizenEmail,Date askDate,String askTitle,String askContent,Date answerDate,String answerContent, int assetEntryId,
		...
		legalFAQEntry.setViewCount(assetEntryId);
		legalFAQEntry.setPublishStatus(publishStatus);
		legalFAQEntry.setStatus(entryStatus);
		
		legalFAQEntryPersistence.update(legalFAQEntry);
