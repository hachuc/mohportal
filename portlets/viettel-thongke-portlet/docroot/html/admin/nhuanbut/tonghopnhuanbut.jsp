...
<portlet:resourceURL var="callMyUrl">
     ...
     <liferay-portlet:renderURL varImpl="nhuanButTongHopNhuanButURL" var="">
       ...
       <aui:row> 
		...
		<aui:row> 
		   <aui:column>
				...
				<aui:input name="fileName" label="" type="hidden" value="tong_hop_nhuan_but.xlsx" ></aui:input>
   ...
   <script>
        document.getElementById("headerReport").innerHTML='<%= LanguageUtil.get(locale, "tong-hop-nhuan-but") %>';
   </script>