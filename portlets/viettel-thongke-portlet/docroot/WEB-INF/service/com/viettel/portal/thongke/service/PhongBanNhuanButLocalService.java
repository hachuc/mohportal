...
/**
 * Provides the local service interface for PhongBanNhuanBut. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author lamvn
 * @see PhongBanNhuanButLocalServiceUtil
...
public interface PhongBanNhuanButLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhongBanNhuanButLocalServiceUtil} to access the phong ban nhuan but local service. Add custom service methods to {@link com.viettel.portal.thongke.service.impl.PhongBanNhuanButLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
