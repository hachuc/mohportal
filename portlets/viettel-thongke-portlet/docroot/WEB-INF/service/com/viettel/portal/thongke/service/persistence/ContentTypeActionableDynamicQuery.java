 ...
 * @generated
 */
public abstract class ContentTypeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ContentTypeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ContentTypeLocalServiceUtil.getService());
		setClass(ContentType.class);

		setClassLoader(com.viettel.portal.thongke.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("contenTypeId");
	}
}