...
public class ContentProfitLocalServiceWrapper
	...
	*/
	...
	public java.util.List findNhuanBut(java.lang.Long groupId,
		...
		return _contentProfitLocalService.findNhuanBut(groupId, fromDate,
			toDate, tinBai, tacGia);
	}
	...
	public java.util.List findContentProfit(java.lang.Long groupId,
		...
		return _contentProfitLocalService.findContentProfit(groupId, fromDate,
			toDate, tinBai, tacGia, start, end);
	}
	...
	public int countTotal(java.lang.Long groupId, java.lang.String fromDate,
		...
		return _contentProfitLocalService.countTotal(groupId, fromDate, toDate,
			tinBai, tacGia);
	}
