...
/**
 * Provides the local service interface for PhongBanNhuanButChiTiet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author lamvn
 * @see PhongBanNhuanButChiTietLocalServiceUtil
...
public interface PhongBanNhuanButChiTietLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhongBanNhuanButChiTietLocalServiceUtil} to access the phong ban nhuan but chi tiet local service. Add custom service methods to {@link com.viettel.portal.thongke.service.impl.PhongBanNhuanButChiTietLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
