        ...
        <div class="row">
	        <div class="col-xs-12">
	        	<div class="form-group form-group-sm">
	                 ...
	                 <input type="text" class="form-control" id="firstname" readonly="readonly" value="<%= HtmlUtil.escape(note.getUserName()) %>" />
	             </div>
	             <div class="form-group form-group-sm">
	             ...
	             <div class="form-group-sm">
	             	 <liferay-ui:message key="body-content" />
	                 <textarea  class="form-control" rows="5"><%= HtmlUtil.escape(note.getContent()) %></textarea>
	             </div>
	         </div>
        </div>
        <div class="row">
             <div class="col-xs-6">
                 <button type="submit" id="<portlet:namespace />closeUpdateFormBtn" name="<portlet:namespace />closeUpdateFormBtn" class="btn btn-default"><liferay-ui:message key="close-window" /></button>
             </div>
             <div class="col-xs-9">
