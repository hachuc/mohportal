	...
	<aui:form action="<%=searchURL%>" method="get" name="fm"
		...
		<liferay-ui:search-container delta="20" emptyResultsMessage="no-result-were-found" iteratorURL="<%= searchURL %>">
			<liferay-ui:search-container-results
				results="<%= ContentLocalServiceUtil.findByStatusVersion(keyword, scopeGroupId,categoryId, showByAuthorId, arrStatus, arrVersion, searchOption, searchContainer.getOrderByComparator(), searchContainer.getStart(), searchContainer.getEnd()) %>"
				total="<%=ContentLocalServiceUtil.countByStatusVersion(keyword, scopeGroupId,categoryId, showByAuthorId, arrStatus, arrVersion) %>"
			/>
