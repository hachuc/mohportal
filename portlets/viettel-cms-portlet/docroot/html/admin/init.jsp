...
<%
	...
	boolean showOnlyOwnContent = GetterUtil.getBoolean(portletPreferences.getValue("showOnlyOwnContent", String.valueOf(false)));
	...
	long showByAuthorId = 0L;
	if(showOnlyOwnContent)
		showByAuthorId = userId;
