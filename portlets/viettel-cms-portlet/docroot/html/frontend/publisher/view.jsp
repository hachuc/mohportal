...
<c:if test="<%=Validator.isNotNull(displayStyle) %>">
	<%
			...
			int publishDay = ParamUtil.getInteger(request, "publishDay", 0);
			int publishMonth = ParamUtil.getInteger(request, "publishMonth", 0);
			int publishYear = ParamUtil.getInteger(request, "publishYear", 0);
			...
			request.setAttribute("view.day", publishDay);
			request.setAttribute("view.month", publishMonth);
			request.setAttribute("view.year", publishYear);
		%>
