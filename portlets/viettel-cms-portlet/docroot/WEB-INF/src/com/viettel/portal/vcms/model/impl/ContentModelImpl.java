...
public class ContentModelImpl extends BaseModelImpl<Content>
	...
	public static final String TABLE_SQL_CREATE = "create table vcms_Content (autoId LONG not null primary key,contentId LONG,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,preVersion INTEGER,version INTEGER,subversion DOUBLE,subTitle STRING null,title STRING null,summary STRING null,subContent STRING null,content TEXT null,smallImageId LONG,smallImageUrl VARCHAR(500) null,categoryId LONG,copyRight VARCHAR(255) null,status INTEGER,urlTitle VARCHAR(500) null,newsType INTEGER,imageUrl VARCHAR(500) null,isLegalContent BOOLEAN,imageCaption VARCHAR(1000) null,imagePosition INTEGER,createdByUserId LONG,editedByUserId LONG,reviewedByUserId LONG,publishedByUserId LONG,createdByUserName VARCHAR(75) null,editedByUserName VARCHAR(75) null,reviewedByUserName VARCHAR(75) null,publishedByUserName VARCHAR(75) null,author VARCHAR(255) null,jobTitle VARCHAR(255) null)";
	...
	public Object clone() {
		...
		contentImpl.setSubversion(getSubversion());
	...
	public CacheModel<Content> toCacheModel() {
		...
		contentCacheModel.subversion = getSubversion();
