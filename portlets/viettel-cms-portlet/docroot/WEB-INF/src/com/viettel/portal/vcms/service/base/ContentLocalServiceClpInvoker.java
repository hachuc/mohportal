...
public class ContentLocalServiceClpInvoker {
	public ContentLocalServiceClpInvoker() {
		...
		_methodName146 = "deleteContentByVersion";

		_methodParameterTypes146 = new String[] { "long", "long", "int[][]" };

		_methodName147 = "findByVersions";

		_methodParameterTypes147 = new String[] { "long", "long", "int[][]" };

		_methodName148 = "fetchByAutoId";

		_methodParameterTypes148 = new String[] { "long", "long" };

		_methodName149 = "findByContentId";

		_methodParameterTypes149 = new String[] { "long", "long", "int", "int" };

		_methodName150 = "addContent";
		...
		_methodName151 = "addLegalContent";
		...
		_methodName152 = "addContentVersion";
		...
		_methodName153 = "removeContent";

		_methodParameterTypes153 = new String[] { "long", "long" };

		_methodName159 = "removeAll";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName146.equals(name) &&
			...
			ContentLocalServiceUtil.deleteContentByVersion(((Long)arguments[0]).longValue(),
		...
		if (_methodName147.equals(name) &&
			...
			return ContentLocalServiceUtil.findByVersions(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(), (int[])arguments[2]);
		}
