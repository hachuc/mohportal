...
public class ContentTypeModelImpl extends BaseModelImpl<ContentType>
	...
	public static final String TABLE_SQL_CREATE = "create table vcms_Content_Type (contenTypeId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,name VARCHAR(255) null,description VARCHAR(255) null,sortOrder INTEGER,cost DOUBLE)";
	...
	public Object clone() {
		...
		contentTypeImpl.setCost(getCost());
	...
	public CacheModel<ContentType> toCacheModel() {
		...
		contentTypeCacheModel.cost = getCost();
