...
import com.viettel.portal.vcms.NoSuchCategoryException;
import com.viettel.portal.vcms.model.Category;
import com.viettel.portal.vcms.model.impl.CategoryImpl;
import com.viettel.portal.vcms.model.impl.CategoryModelImpl;
...
public class CategoryPersistenceImpl extends BasePersistenceImpl<Category>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C = new FinderPath(CategoryModelImpl.ENTITY_CACHE_ENABLED,
			CategoryModelImpl.FINDER_CACHE_ENABLED, CategoryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_C = new FinderPath(CategoryModelImpl.ENTITY_CACHE_ENABLED,
			CategoryModelImpl.FINDER_CACHE_ENABLED, CategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_C",
			new String[] { Long.class.getName() },
			CategoryModelImpl.GROUPID_COLUMN_BITMASK |
			CategoryModelImpl.SORTORDER_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C = new FinderPath(CategoryModelImpl.ENTITY_CACHE_ENABLED,
			CategoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Category> findByG_C(long groupId) throws SystemException {
		return findByG_C(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Category> findByG_C(long groupId, int start, int end)
		throws SystemException {
		return findByG_C(groupId, start, end, null);
	}
	 ...
	 */
	@Override
	public Category findByG_C_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		Category category = fetchByG_C_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Category fetchByG_C_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Category> list = findByG_C(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Category findByG_C_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		Category category = fetchByG_C_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Category fetchByG_C_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByG_C(groupId);

		if (count == 0) {
			return null;
		}

		List<Category> list = findByG_C(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Category[] findByG_C_PrevAndNext(long categoryId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		...
		try {
			...
			array[0] = getByG_C_PrevAndNext(session, category, groupId,
					orderByComparator, true);

			array[1] = category;

			array[2] = getByG_C_PrevAndNext(session, category, groupId,
	...
	protected Category getByG_C_PrevAndNext(Session session, Category category,
	 ...
	 */
	@Override
	public List<Category> filterFindByG_C(long groupId)
		throws SystemException {
		return filterFindByG_C(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<Category> filterFindByG_C(long groupId, int start, int end)
		throws SystemException {
		return filterFindByG_C(groupId, start, end, null);
	}
	...
	public List<Category> filterFindByG_C(long groupId, int start, int end,
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C(groupId, start, end, orderByComparator);
		}
	 ...
	 */
	@Override
	public Category[] filterFindByG_C_PrevAndNext(long categoryId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C_PrevAndNext(categoryId, groupId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_C_PrevAndNext(session, category, groupId,
					orderByComparator, true);

			array[1] = category;

			array[2] = filterGetByG_C_PrevAndNext(session, category, groupId,
					orderByComparator, false);
	...
	protected Category filterGetByG_C_PrevAndNext(Session session,
		Category category, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByG_C(long groupId) throws SystemException {
		for (Category category : findByG_C(groupId, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public int countByG_C(long groupId) throws SystemException {
	 ...
	 */
	@Override
	public int filterCountByG_C(long groupId) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_C(groupId);
		}
	...
	private static final String _FINDER_COLUMN_G_C_GROUPID_2 = "category.groupId = ?";
	...
	@Override
	public Category updateImpl(com.viettel.portal.vcms.model.Category category)
		throws SystemException {
		category = toUnwrappedModel(category);
	...
	protected Category toUnwrappedModel(Category category) {
		...
		categoryImpl.setSortOrder(category.getSortOrder());
		categoryImpl.setArchived(category.isArchived());
		categoryImpl.setLayoutId(category.getLayoutId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.viettel.portal.vcms.model.Category")));
	...
	private static final String _FILTER_SQL_SELECT_CATEGORY_WHERE = "SELECT DISTINCT {category.*} FROM vcms_Category category WHERE ";
	private static final String _FILTER_SQL_SELECT_CATEGORY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {vcms_Category.*} FROM (SELECT DISTINCT category.categoryId FROM vcms_Category category WHERE ";
	private static final String _FILTER_SQL_SELECT_CATEGORY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN vcms_Category ON TEMP_TABLE.categoryId = vcms_Category.categoryId";
	private static final String _FILTER_SQL_COUNT_CATEGORY_WHERE = "SELECT COUNT(DISTINCT category.categoryId) AS COUNT_VALUE FROM vcms_Category category WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "category";
	private static final String _FILTER_ENTITY_TABLE = "vcms_Category";
	private static final String _ORDER_BY_ENTITY_ALIAS = "category.";
	private static final String _ORDER_BY_ENTITY_TABLE = "vcms_Category.";
