...
import com.viettel.portal.vcms.service.persistence.DistributionFinderUtil;
...
public class DistributionLocalServiceImpl
	...
	public void unPublishContent(long groupId, long contentId) throws PortalException, SystemException{
		...
		for(Distribution di : lstDistribution){
			distributionPersistence.remove(di.getDistributionId());
		}
	}
	...
	public Distribution fetchOneByContentId(long contentId, long groupId) throws PortalException, SystemException{
		return DistributionUtil.fetchByGroupContentId_First(groupId, contentId, null);
	}
	
	public List findByVersionAndStatus(long groupId, long categoryId, String keyword, long authorId, int searchOption, int start, int end) throws PortalException, SystemException{
		return DistributionFinderUtil.findByVersionAndStatus(groupId, categoryId, keyword, authorId, searchOption, start, end);
	}
	
	public List getMostViewedNews(long groupId, long[] categoryIds, Date fromDate, Date toDate, int start, int end) throws SystemException, PortalException{
		return DistributionFinderUtil.getMostViewedNews(groupId, categoryIds, fromDate, toDate, start, end);
	}
	
	public int countByVersionAndStatus(long groupId, long categoryId, String keyword, long authorId, int searchOption) throws PortalException, SystemException{
		return DistributionFinderUtil.countByVersionAndStatus(groupId, categoryId, keyword, authorId, searchOption);
	}
}