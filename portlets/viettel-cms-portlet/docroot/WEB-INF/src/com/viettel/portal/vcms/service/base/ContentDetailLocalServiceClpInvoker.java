...
public class ContentDetailLocalServiceClpInvoker {
	public ContentDetailLocalServiceClpInvoker() {
		...
		_methodName128 = "deleteByVersions";

		_methodParameterTypes128 = new String[] { "long", "long", "int[][]" };

		_methodName129 = "findByVersions";

		_methodParameterTypes129 = new String[] { "long", "long", "int[][]" };

		_methodName130 = "removeAll";

		_methodParameterTypes130 = new String[] {  };

		_methodName131 = "addContentDetail";
		...
		_methodName132 = "addLegalContent";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName128.equals(name) &&
			...
			ContentDetailLocalServiceUtil.deleteByVersions(((Long)arguments[0]).longValue(),
		...
		if (_methodName129.equals(name) &&
			...
			return ContentDetailLocalServiceUtil.findByVersions(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(), (int[])arguments[2]);
		}
