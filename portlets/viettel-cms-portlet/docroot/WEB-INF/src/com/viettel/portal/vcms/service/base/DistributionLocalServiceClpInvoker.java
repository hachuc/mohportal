...
public class DistributionLocalServiceClpInvoker {
	public DistributionLocalServiceClpInvoker() {
		...
		_methodName140 = "fetchOneByContentId";

		_methodParameterTypes140 = new String[] { "long", "long" };

		_methodName141 = "findByVersionAndStatus";

		_methodParameterTypes141 = new String[] {
				"long", "long", "java.lang.String", "long", "int", "int", "int"
			};

		_methodName142 = "getMostViewedNews";
		...
		_methodName143 = "countByVersionAndStatus";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName140.equals(name) &&
			...
			return DistributionLocalServiceUtil.fetchOneByContentId(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName141.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes141, parameterTypes)) {
			return DistributionLocalServiceUtil.findByVersionAndStatus(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(),
		...
		if (_methodName142.equals(name) &&
			...
			return DistributionLocalServiceUtil.getMostViewedNews(((Long)arguments[0]).longValue(),
				(long[])arguments[1], (java.util.Date)arguments[2],
		...
		if (_methodName143.equals(name) &&
			...
			return DistributionLocalServiceUtil.countByVersionAndStatus(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(),
				(java.lang.String)arguments[2],
				((Long)arguments[3]).longValue(),
				((Integer)arguments[4]).intValue());
