...
public class CommentPersistenceImpl extends BasePersistenceImpl<Comment>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_D_V = new FinderPath(CommentModelImpl.ENTITY_CACHE_ENABLED,
			CommentModelImpl.FINDER_CACHE_ENABLED, CommentImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_D_V",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_D_V = new FinderPath(CommentModelImpl.ENTITY_CACHE_ENABLED,
			CommentModelImpl.FINDER_CACHE_ENABLED, CommentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_D_V",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
			CommentModelImpl.GROUPID_COLUMN_BITMASK |
			CommentModelImpl.DISTRIBUTIONID_COLUMN_BITMASK |
			CommentModelImpl.VISIBLE_COLUMN_BITMASK |
			CommentModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_D_V = new FinderPath(CommentModelImpl.ENTITY_CACHE_ENABLED,
			CommentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_D_V",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});
	 ...
	 */
	@Override
	public List<Comment> findByG_D_V(long groupId, long distributionId,
		boolean visible) throws SystemException {
		return findByG_D_V(groupId, distributionId, visible, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<Comment> findByG_D_V(long groupId, long distributionId,
		boolean visible, int start, int end) throws SystemException {
		return findByG_D_V(groupId, distributionId, visible, start, end, null);
	}
	...
	@Override
	public List<Comment> findByG_D_V(long groupId, long distributionId,
		boolean visible, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_D_V;
			finderArgs = new Object[] { groupId, distributionId, visible };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_D_V;
			finderArgs = new Object[] {
					groupId, distributionId, visible,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_D_V_GROUPID_2);

			query.append(_FINDER_COLUMN_G_D_V_DISTRIBUTIONID_2);

			query.append(_FINDER_COLUMN_G_D_V_VISIBLE_2);
	 ...
	 */
	@Override
	public Comment findByG_D_V_First(long groupId, long distributionId,
		boolean visible, OrderByComparator orderByComparator)
		throws NoSuchCommentException, SystemException {
		Comment comment = fetchByG_D_V_First(groupId, distributionId, visible,
				orderByComparator);
	 ...
	 */
	@Override
	public Comment fetchByG_D_V_First(long groupId, long distributionId,
		boolean visible, OrderByComparator orderByComparator)
		throws SystemException {
		List<Comment> list = findByG_D_V(groupId, distributionId, visible, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public Comment findByG_D_V_Last(long groupId, long distributionId,
		boolean visible, OrderByComparator orderByComparator)
		throws NoSuchCommentException, SystemException {
		Comment comment = fetchByG_D_V_Last(groupId, distributionId, visible,
				orderByComparator);
	 ...
	 */
	@Override
	public Comment fetchByG_D_V_Last(long groupId, long distributionId,
		boolean visible, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_D_V(groupId, distributionId, visible);

		if (count == 0) {
			return null;
		}

		List<Comment> list = findByG_D_V(groupId, distributionId, visible,
	 ...
	 */
	@Override
	public Comment[] findByG_D_V_PrevAndNext(long commentId, long groupId,
		long distributionId, boolean visible,
		OrderByComparator orderByComparator)
		throws NoSuchCommentException, SystemException {
		Comment comment = findByPrimaryKey(commentId);
		...
		try {
			...
			array[0] = getByG_D_V_PrevAndNext(session, comment, groupId,
					distributionId, visible, orderByComparator, true);

			array[1] = comment;

			array[2] = getByG_D_V_PrevAndNext(session, comment, groupId,
					distributionId, visible, orderByComparator, false);
	...
	protected Comment getByG_D_V_PrevAndNext(Session session, Comment comment,
	...
	public void removeByG_D_V(long groupId, long distributionId, boolean visible)
		throws SystemException {
		for (Comment comment : findByG_D_V(groupId, distributionId, visible,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(comment);
		}
	}
	...
	public int countByG_D_V(long groupId, long distributionId, boolean visible)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_D_V;

		Object[] finderArgs = new Object[] { groupId, distributionId, visible };
	...
	private static final String _FINDER_COLUMN_G_D_V_GROUPID_2 = "comment.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_D_V_DISTRIBUTIONID_2 = "comment.distributionId = ? AND ";
	private static final String _FINDER_COLUMN_G_D_V_VISIBLE_2 = "comment.visible = ?";
	...
	public Comment updateImpl(com.viettel.portal.vcms.model.Comment comment)
		...
		if (isNew || !CommentModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((commentModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_D_V.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						commentModelImpl.getOriginalGroupId(),
						commentModelImpl.getOriginalDistributionId(),
						commentModelImpl.getOriginalVisible()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_D_V, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_D_V,
					args);

				args = new Object[] {
						commentModelImpl.getGroupId(),
						commentModelImpl.getDistributionId(),
						commentModelImpl.getVisible()
					};
