...
public class DistributionLocalServiceWrapper implements DistributionLocalService,
	...
	*/
	...
	public com.viettel.portal.vcms.model.Distribution fetchOneByContentId(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _distributionLocalService.fetchOneByContentId(contentId, groupId);
	}
	...
	public java.util.List findByVersionAndStatus(long groupId, long categoryId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _distributionLocalService.findByVersionAndStatus(groupId,
			categoryId, keyword, authorId, searchOption, start, end);
	}
	...
	public java.util.List getMostViewedNews(long groupId, long[] categoryIds,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _distributionLocalService.getMostViewedNews(groupId,
			categoryIds, fromDate, toDate, start, end);
	}
	...
	public int countByVersionAndStatus(long groupId, long categoryId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _distributionLocalService.countByVersionAndStatus(groupId,
			categoryId, keyword, authorId, searchOption);
	}
