 ...
 * @generated
 */
public abstract class DistributionActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DistributionActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DistributionLocalServiceUtil.getService());
		setClass(Distribution.class);

		setClassLoader(com.viettel.portal.vcms.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("distributionId");
	}
}