...
/**
 * Provides the local service interface for Legal_Zone. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author chuchv
 * @see Legal_ZoneLocalServiceUtil
...
public interface Legal_ZoneLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Legal_ZoneLocalServiceUtil} to access the legal_ zone local service. Add custom service methods to {@link com.viettel.portal.vcms.service.impl.Legal_ZoneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
