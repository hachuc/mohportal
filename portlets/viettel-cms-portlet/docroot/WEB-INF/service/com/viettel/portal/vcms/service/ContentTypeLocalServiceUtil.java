...
public class ContentTypeLocalServiceUtil {
	...
	*/
	...
	public static void updateContentType(long groupId, long companyId,
		...
		java.lang.String desc, int sortOrder, double cost,
		com.liferay.portal.service.ServiceContext context)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.updateContentType(groupId, companyId, userId, contentTypeId, name,
			desc, sortOrder, cost, context);
	}

	public static java.util.List<com.viettel.portal.vcms.model.ContentType> getAllContentType(
		long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getAllContentType(groupId);
	}
