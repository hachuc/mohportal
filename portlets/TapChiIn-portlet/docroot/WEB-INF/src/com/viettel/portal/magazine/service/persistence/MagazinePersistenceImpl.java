...
import com.viettel.portal.magazine.NoSuchMagazineException;
import com.viettel.portal.magazine.model.Magazine;
import com.viettel.portal.magazine.model.impl.MagazineImpl;
import com.viettel.portal.magazine.model.impl.MagazineModelImpl;
...
public class MagazinePersistenceImpl extends BasePersistenceImpl<Magazine>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PUBLISHNUMBERANDYEAR =
		new FinderPath(MagazineModelImpl.ENTITY_CACHE_ENABLED,
			...
			MagazineModelImpl.DISTRIBUTEDDATE_COLUMN_BITMASK);
	...
	/**
	 * Returns all the magazines where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 * @param PublishNumber the publish number
	 * @param PublishYear the publish year
	 * @return the matching magazines
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public List<Magazine> findByPublishNumberAndYear(int PublishNumber,
		int PublishYear) throws SystemException {
		return findByPublishNumberAndYear(PublishNumber, PublishYear,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the magazines where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 * <p>
	...
	@Override
	public List<Magazine> findByPublishNumberAndYear(int PublishNumber,
		int PublishYear, int start, int end) throws SystemException {
		return findByPublishNumberAndYear(PublishNumber, PublishYear, start,
			end, null);
	}

	/**
	 * Returns an ordered range of all the magazines where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.viettel.portal.magazine.model.impl.MagazineModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<Magazine> findByPublishNumberAndYear(int PublishNumber,
		int PublishYear, int start, int end, OrderByComparator orderByComparator)
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { PublishNumber, PublishYear };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_PUBLISHNUMBERANDYEAR;
			finderArgs = new Object[] {
					PublishNumber, PublishYear,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Magazine magazine : list) {
				if ((PublishNumber != magazine.getPublishNumber()) ||
						(PublishYear != magazine.getPublishYear())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_PUBLISHNUMBERANDYEAR_PUBLISHNUMBER_2);
	...
	/**
	 * Returns the first magazine in the ordered set where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 * @param PublishNumber the publish number
	 * @param PublishYear the publish year
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching magazine
	 * @throws com.viettel.portal.magazine.NoSuchMagazineException if a matching magazine could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public Magazine findByPublishNumberAndYear_First(int PublishNumber,
		int PublishYear, OrderByComparator orderByComparator)
		throws NoSuchMagazineException, SystemException {
		Magazine magazine = fetchByPublishNumberAndYear_First(PublishNumber,
				PublishYear, orderByComparator);
	 ...
	 */
	@Override
	public Magazine fetchByPublishNumberAndYear_First(int PublishNumber,
		int PublishYear, OrderByComparator orderByComparator)
		throws SystemException {
		List<Magazine> list = findByPublishNumberAndYear(PublishNumber,
				PublishYear, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last magazine in the ordered set where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 * @param PublishNumber the publish number
	 * @param PublishYear the publish year
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Magazine findByPublishNumberAndYear_Last(int PublishNumber,
		int PublishYear, OrderByComparator orderByComparator)
		throws NoSuchMagazineException, SystemException {
		Magazine magazine = fetchByPublishNumberAndYear_Last(PublishNumber,
				PublishYear, orderByComparator);
	 ...
	 */
	@Override
	public Magazine fetchByPublishNumberAndYear_Last(int PublishNumber,
		int PublishYear, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByPublishNumberAndYear(PublishNumber, PublishYear);
		...
		List<Magazine> list = findByPublishNumberAndYear(PublishNumber,
				PublishYear, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the magazines before and after the current magazine in the ordered set where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 ...
	 * @throws com.viettel.portal.magazine.NoSuchMagazineException if a magazine with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public Magazine[] findByPublishNumberAndYear_PrevAndNext(int ID,
		int PublishNumber, int PublishYear, OrderByComparator orderByComparator)
		throws NoSuchMagazineException, SystemException {
		...
		try {
			...
			array[0] = getByPublishNumberAndYear_PrevAndNext(session, magazine,
					PublishNumber, PublishYear, orderByComparator, true);

			array[1] = magazine;

			array[2] = getByPublishNumberAndYear_PrevAndNext(session, magazine,
					PublishNumber, PublishYear, orderByComparator, false);
	...
	protected Magazine getByPublishNumberAndYear_PrevAndNext(Session session,
		Magazine magazine, int PublishNumber, int PublishYear,
	...
	/**
	 * Removes all the magazines where PublishNumber = &#63; and PublishYear = &#63; from the database.
	 *
	 * @param PublishNumber the publish number
	 * @param PublishYear the publish year
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public void removeByPublishNumberAndYear(int PublishNumber, int PublishYear)
		throws SystemException {
		for (Magazine magazine : findByPublishNumberAndYear(PublishNumber,
				PublishYear, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(magazine);
		}
	}

	/**
	 * Returns the number of magazines where PublishNumber = &#63; and PublishYear = &#63;.
	 *
	 * @param PublishNumber the publish number
	 * @param PublishYear the publish year
	 ...
	 */
	@Override
	public int countByPublishNumberAndYear(int PublishNumber, int PublishYear)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_PUBLISHNUMBERANDYEAR;

		Object[] finderArgs = new Object[] { PublishNumber, PublishYear };
	...
	private static final String _FINDER_COLUMN_PUBLISHNUMBERANDYEAR_PUBLISHNUMBER_2 =
		"magazine.PublishNumber = ? AND ";
	private static final String _FINDER_COLUMN_PUBLISHNUMBERANDYEAR_PUBLISHYEAR_2 =
		"magazine.PublishYear = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PUBLISHYEAR =
		new FinderPath(MagazineModelImpl.ENTITY_CACHE_ENABLED,
			MagazineModelImpl.FINDER_CACHE_ENABLED, MagazineImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByPublishYear",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PUBLISHYEAR =
		new FinderPath(MagazineModelImpl.ENTITY_CACHE_ENABLED,
			MagazineModelImpl.FINDER_CACHE_ENABLED, MagazineImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByPublishYear",
			new String[] { Integer.class.getName() },
			MagazineModelImpl.PUBLISHYEAR_COLUMN_BITMASK |
			MagazineModelImpl.DISTRIBUTEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PUBLISHYEAR = new FinderPath(MagazineModelImpl.ENTITY_CACHE_ENABLED,
			MagazineModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByPublishYear",
			new String[] { Integer.class.getName() });
	 ...
	 */
	@Override
	public List<Magazine> findByPublishYear(int PublishYear)
		throws SystemException {
		return findByPublishYear(PublishYear, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public List<Magazine> findByPublishYear(int PublishYear, int start, int end)
		throws SystemException {
		return findByPublishYear(PublishYear, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Magazine> findByPublishYear(int PublishYear, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PUBLISHYEAR;
			finderArgs = new Object[] { PublishYear };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_PUBLISHYEAR;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_PUBLISHYEAR_PUBLISHYEAR_2);
	 ...
	 */
	@Override
	public Magazine findByPublishYear_First(int PublishYear,
		OrderByComparator orderByComparator)
		throws NoSuchMagazineException, SystemException {
		Magazine magazine = fetchByPublishYear_First(PublishYear,
				orderByComparator);
	 ...
	 */
	@Override
	public Magazine fetchByPublishYear_First(int PublishYear,
		OrderByComparator orderByComparator) throws SystemException {
		List<Magazine> list = findByPublishYear(PublishYear, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Magazine findByPublishYear_Last(int PublishYear,
		OrderByComparator orderByComparator)
		throws NoSuchMagazineException, SystemException {
		Magazine magazine = fetchByPublishYear_Last(PublishYear,
				orderByComparator);
	 ...
	 */
	@Override
	public Magazine fetchByPublishYear_Last(int PublishYear,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByPublishYear(PublishYear);

		if (count == 0) {
			return null;
		}

		List<Magazine> list = findByPublishYear(PublishYear, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Magazine[] findByPublishYear_PrevAndNext(int ID, int PublishYear,
		OrderByComparator orderByComparator)
		throws NoSuchMagazineException, SystemException {
		Magazine magazine = findByPrimaryKey(ID);
		...
		try {
			...
			array[0] = getByPublishYear_PrevAndNext(session, magazine,
					PublishYear, orderByComparator, true);

			array[1] = magazine;

			array[2] = getByPublishYear_PrevAndNext(session, magazine,
	...
	protected Magazine getByPublishYear_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public void removeByPublishYear(int PublishYear) throws SystemException {
		for (Magazine magazine : findByPublishYear(PublishYear,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(magazine);
		}
	}
	 ...
	 */
	@Override
	public int countByPublishYear(int PublishYear) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_PUBLISHYEAR;
	...
	private static final String _FINDER_COLUMN_PUBLISHYEAR_PUBLISHYEAR_2 = "magazine.PublishYear = ?";
		...
		if (isNew || !MagazineModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((magazineModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						magazineModelImpl.getOriginalPublishNumber(),
				...
				args = new Object[] {
						magazineModelImpl.getPublishNumber(),
						magazineModelImpl.getPublishYear()
					};
			...
			if ((magazineModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PUBLISHYEAR.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						magazineModelImpl.getOriginalPublishYear()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_PUBLISHYEAR,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PUBLISHYEAR,
					args);
	...
	protected Magazine toUnwrappedModel(Magazine magazine) {
		...
		magazineImpl.setImageID(magazine.getImageID());
		magazineImpl.setCreationDate(magazine.getCreationDate());
		magazineImpl.setModifiedDate(magazine.getModifiedDate());
		magazineImpl.setDistributedDate(magazine.getDistributedDate());
	...
	/**
	 * Returns the magazine with the primary key or throws a {@link com.viettel.portal.magazine.NoSuchMagazineException} if it could not be found.
	 *
	 * @param ID the primary key of the magazine
	 * @return the magazine
	 * @throws com.viettel.portal.magazine.NoSuchMagazineException if a magazine with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.viettel.portal.magazine.model.Magazine")));
