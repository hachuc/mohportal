...
import com.viettel.portal.magazine.service.MagazineContentLocalService;
...
/**
 * Provides the base implementation for the magazine content local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.portal.magazine.service.impl.MagazineContentLocalServiceImpl}.
 * </p>
 *
 * @author namtv
 ...
 * @generated
 */
public abstract class MagazineContentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MagazineContentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.portal.magazine.service.MagazineContentLocalServiceUtil} to access the magazine content local service.
	 */
	...
	@Override
	public MagazineContent addMagazineContent(MagazineContent magazineContent)
		throws SystemException {
		magazineContent.setNew(true);

		return magazineContentPersistence.update(magazineContent);
	}
	 ...
	 */
	@Override
	public MagazineContent createMagazineContent(int ID) {
		return magazineContentPersistence.create(ID);
	}
	...
	@Override
	public MagazineContent deleteMagazineContent(int ID)
		throws PortalException, SystemException {
		return magazineContentPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MagazineContent deleteMagazineContent(
		MagazineContent magazineContent) throws SystemException {
		return magazineContentPersistence.remove(magazineContent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MagazineContent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return magazineContentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return magazineContentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MagazineContent fetchMagazineContent(int ID)
		throws SystemException {
		return magazineContentPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public MagazineContent getMagazineContent(int ID)
		throws PortalException, SystemException {
		return magazineContentPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return magazineContentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MagazineContent> getMagazineContents(int start, int end)
		throws SystemException {
		return magazineContentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMagazineContentsCount() throws SystemException {
		return magazineContentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MagazineContent updateMagazineContent(
		MagazineContent magazineContent) throws SystemException {
		return magazineContentPersistence.update(magazineContent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.portal.magazine.model.MagazineContent",
			magazineContentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = magazineContentPersistence.getDataSource();
	...
	private MagazineContentLocalServiceClpInvoker _clpInvoker = new MagazineContentLocalServiceClpInvoker();
}