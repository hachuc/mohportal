...
/**
 * Provides the base implementation for the magazine zone local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.portal.magazine.service.impl.MagazineZoneLocalServiceImpl}.
 * </p>
 *
 * @author namtv
 ...
 * @generated
 */
public abstract class MagazineZoneLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MagazineZoneLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.portal.magazine.service.MagazineZoneLocalServiceUtil} to access the magazine zone local service.
	 */
	...
	@Override
	public MagazineZone addMagazineZone(MagazineZone magazineZone)
		throws SystemException {
		magazineZone.setNew(true);

		return magazineZonePersistence.update(magazineZone);
	}
	 ...
	 */
	@Override
	public MagazineZone createMagazineZone(int ID) {
		return magazineZonePersistence.create(ID);
	}
	...
	@Override
	public MagazineZone deleteMagazineZone(int ID)
		throws PortalException, SystemException {
		return magazineZonePersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MagazineZone deleteMagazineZone(MagazineZone magazineZone)
		throws SystemException {
		return magazineZonePersistence.remove(magazineZone);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MagazineZone.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return magazineZonePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return magazineZonePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MagazineZone fetchMagazineZone(int ID) throws SystemException {
		return magazineZonePersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public MagazineZone getMagazineZone(int ID)
		throws PortalException, SystemException {
		return magazineZonePersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return magazineZonePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MagazineZone> getMagazineZones(int start, int end)
		throws SystemException {
		return magazineZonePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMagazineZonesCount() throws SystemException {
		return magazineZonePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MagazineZone updateMagazineZone(MagazineZone magazineZone)
		throws SystemException {
		return magazineZonePersistence.update(magazineZone);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.portal.magazine.model.MagazineZone",
			magazineZoneLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = magazineZonePersistence.getDataSource();
	...
	private MagazineZoneLocalServiceClpInvoker _clpInvoker = new MagazineZoneLocalServiceClpInvoker();
}