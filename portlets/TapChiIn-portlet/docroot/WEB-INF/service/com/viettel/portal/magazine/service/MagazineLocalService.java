...
/**
 * Provides the local service interface for Magazine. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author namtv
 * @see MagazineLocalServiceUtil
...
public interface MagazineLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MagazineLocalServiceUtil} to access the magazine local service. Add custom service methods to {@link com.viettel.portal.magazine.service.impl.MagazineLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
