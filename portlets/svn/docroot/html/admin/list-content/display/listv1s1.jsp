...
<div class="form-search ">
	<aui:form action="<%=searchURL%>" method="get" name="fm"
		...
		<%
		List<Content> lstResults = ContentLocalServiceUtil.findByStatusVersion(keyword, scopeGroupId,categoryId, 0L, arrStatus, arrVersion, searchOption, searchContainer.getOrderByComparator(), searchContainer.getStart(), searchContainer.getEnd()); 
		int totalA = ContentLocalServiceUtil.countByStatusVersion(keyword, scopeGroupId,categoryId, 0L, arrStatus, arrVersion);
		%>
			...
			>
				...
				>
					...
					<portlet:actionURL var="transferURL" name="sendToNextStep">
						<portlet:param name="autoId" value="<%= String.valueOf(content.getAutoId()) %>"/>
					...
					<a href="<%= transferURL.toString() %>" title="Gửi đi"><i class="glyphicon icon-circle-arrow-right"></i></a>
