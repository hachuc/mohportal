...
%>
<style>
	#<portlet:namespace />contentsSearchContainer_col-review-title, #<portlet:namespace />contentsSearchContainer_col-create-date{
		text-align: center;
	}
</style>
		...
		<liferay-ui:search-container delta="20" emptyResultsMessage="no-result-were-found" iteratorURL="<%= searchURL %>">
			...
			>
				...
				<liferay-ui:search-container-column-text
					href="<%=rowURL %>"
					name="review-title"
					value="<%= content.getEditedByUserName()%>"
				/>
				<liferay-ui:search-container-column-text
					href="<%=rowURL %>"
					name="create-date"
				...
				<liferay-ui:search-container-column-text
					...
					<a href="<%= editActionURL.toString() %>" title="Chọn triển khai" ><i class="glyphicon icon-wrench"></i></a>
