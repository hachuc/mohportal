...
/**
 * Provides the local service interface for DistributionVisisted. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author chuchv
 * @see DistributionVisistedLocalServiceUtil
...
public interface DistributionVisistedLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DistributionVisistedLocalServiceUtil} to access the distribution visisted local service. Add custom service methods to {@link com.viettel.portal.vcms.service.impl.DistributionVisistedLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
