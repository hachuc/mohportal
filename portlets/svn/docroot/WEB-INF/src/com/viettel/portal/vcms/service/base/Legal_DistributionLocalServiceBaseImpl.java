...
import com.viettel.portal.vcms.service.Legal_DistributionLocalService;
...
/**
 * Provides the base implementation for the legal_ distribution local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.portal.vcms.service.impl.Legal_DistributionLocalServiceImpl}.
 * </p>
 *
 * @author chuchv
 ...
 * @generated
 */
public abstract class Legal_DistributionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Legal_DistributionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.portal.vcms.service.Legal_DistributionLocalServiceUtil} to access the legal_ distribution local service.
	 */
	...
	@Override
	public Legal_Distribution addLegal_Distribution(
		Legal_Distribution legal_Distribution) throws SystemException {
		legal_Distribution.setNew(true);

		return legal_DistributionPersistence.update(legal_Distribution);
	}
	 ...
	 */
	@Override
	public Legal_Distribution createLegal_Distribution(int ID) {
		return legal_DistributionPersistence.create(ID);
	}
	...
	@Override
	public Legal_Distribution deleteLegal_Distribution(int ID)
		throws PortalException, SystemException {
		return legal_DistributionPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Legal_Distribution deleteLegal_Distribution(
		Legal_Distribution legal_Distribution) throws SystemException {
		return legal_DistributionPersistence.remove(legal_Distribution);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Legal_Distribution.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legal_DistributionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legal_DistributionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Legal_Distribution fetchLegal_Distribution(int ID)
		throws SystemException {
		return legal_DistributionPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public Legal_Distribution getLegal_Distribution(int ID)
		throws PortalException, SystemException {
		return legal_DistributionPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legal_DistributionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Legal_Distribution> getLegal_Distributions(int start, int end)
		throws SystemException {
		return legal_DistributionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegal_DistributionsCount() throws SystemException {
		return legal_DistributionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Legal_Distribution updateLegal_Distribution(
		Legal_Distribution legal_Distribution) throws SystemException {
		return legal_DistributionPersistence.update(legal_Distribution);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.portal.vcms.model.Legal_Distribution",
			legal_DistributionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legal_DistributionPersistence.getDataSource();
	...
	private Legal_DistributionLocalServiceClpInvoker _clpInvoker = new Legal_DistributionLocalServiceClpInvoker();
}