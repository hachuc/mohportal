...
public class ContentDetailModelImpl extends BaseModelImpl<ContentDetail>
	...
	public static final String TABLE_SQL_CREATE = "create table vcms_Content_Detail (autoId LONG not null primary key,contentId LONG,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,version INTEGER,subTitle STRING null,title STRING null,summary STRING null,subContent STRING null,content TEXT null,smallImageId LONG,smallImageUrl VARCHAR(500) null,categoryId LONG,status INTEGER,newsType INTEGER,imageUrl VARCHAR(500) null,isLegalContent BOOLEAN,imageCaption VARCHAR(1000) null,imagePosition INTEGER)";
