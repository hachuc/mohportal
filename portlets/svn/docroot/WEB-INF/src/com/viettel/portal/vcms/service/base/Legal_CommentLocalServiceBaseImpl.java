...
import com.viettel.portal.vcms.service.Legal_CommentLocalService;
...
/**
 * Provides the base implementation for the legal_ comment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.portal.vcms.service.impl.Legal_CommentLocalServiceImpl}.
 * </p>
 *
 * @author chuchv
 ...
 * @generated
 */
public abstract class Legal_CommentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Legal_CommentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.portal.vcms.service.Legal_CommentLocalServiceUtil} to access the legal_ comment local service.
	 */
	...
	@Override
	public Legal_Comment addLegal_Comment(Legal_Comment legal_Comment)
		throws SystemException {
		legal_Comment.setNew(true);

		return legal_CommentPersistence.update(legal_Comment);
	}
	 ...
	 */
	@Override
	public Legal_Comment createLegal_Comment(int ID) {
		return legal_CommentPersistence.create(ID);
	}
	...
	@Override
	public Legal_Comment deleteLegal_Comment(int ID)
		throws PortalException, SystemException {
		return legal_CommentPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Legal_Comment deleteLegal_Comment(Legal_Comment legal_Comment)
		throws SystemException {
		return legal_CommentPersistence.remove(legal_Comment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Legal_Comment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legal_CommentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legal_CommentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Legal_Comment fetchLegal_Comment(int ID) throws SystemException {
		return legal_CommentPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public Legal_Comment getLegal_Comment(int ID)
		throws PortalException, SystemException {
		return legal_CommentPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legal_CommentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Legal_Comment> getLegal_Comments(int start, int end)
		throws SystemException {
		return legal_CommentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegal_CommentsCount() throws SystemException {
		return legal_CommentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Legal_Comment updateLegal_Comment(Legal_Comment legal_Comment)
		throws SystemException {
		return legal_CommentPersistence.update(legal_Comment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.portal.vcms.model.Legal_Comment",
			legal_CommentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legal_CommentPersistence.getDataSource();
	...
	private Legal_CommentLocalServiceClpInvoker _clpInvoker = new Legal_CommentLocalServiceClpInvoker();
}