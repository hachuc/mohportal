...
%>
	...
	config.extraPlugins = 'video,media,scayt,wsc,youtube,font';
	...
	CKEDITOR.config.toolbar_liferay = [
		...
		['Source'],
		['Link', 'Unlink', 'Anchor'],
		['Image', 'Video', 'Audio', 'Youtube', 'Table', '-', 'Smiley', 'SpecialChar']
	];
	...
	CKEDITOR.config.toolbar_liferayArticle = [
		...
		['Source'],
		['Link', 'Unlink', 'Anchor'],
		['Image', 'Video', 'Audio', 'Youtube', 'Table', '-', 'Smiley', 'SpecialChar', 'LiferayPageBreak']
	];
