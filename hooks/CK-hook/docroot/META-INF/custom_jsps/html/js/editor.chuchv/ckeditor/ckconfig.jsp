...
%>
	...
	config.extraPlugins = 'media,scayt,wsc,video,youtube,font';
	...
	CKEDITOR.config.toolbar_liferay = [
		...
		['Source'],
		['Link', 'Unlink', 'Anchor'],
		['Image', 'Video','Media', 'Youtube', 'Table', '-', 'Smiley', 'SpecialChar']
	];
	...
	CKEDITOR.config.toolbar_liferayArticle = [
		...
		['Source'],
		['Link', 'Unlink', 'Anchor'],
		['Image', 'Video','Media', 'Youtube', 'Table', '-', 'Smiley', 'SpecialChar', 'LiferayPageBreak']
	];
