...
boolean focusTopNews = GetterUtil.getBoolean(portletPreferences.getValue("focusTopNews", null), true);
boolean showCmsPublishDate = GetterUtil.getBoolean(portletPreferences.getValue("showCmsPublishDate", null), true);
boolean showCmsPublishDateLabel = GetterUtil.getBoolean(portletPreferences.getValue("showCmsPublishDateLabel", null), true);
boolean showCmsViewCount = GetterUtil.getBoolean(portletPreferences.getValue("showCmsViewCount", null), true);
boolean exportCmsContent = GetterUtil.getBoolean(portletPreferences.getValue("exportCmsContent", null), true);
boolean showCmsViewMore = GetterUtil.getBoolean(portletPreferences.getValue("showCmsViewMore", null), false);
boolean showSearchByDate = GetterUtil.getBoolean(portletPreferences.getValue("showSearchByDate", null), false);
...
boolean enableeditlive = GetterUtil.getBoolean(portletPreferences.getValue("enableeditlive", null), true);
boolean showneworther = GetterUtil.getBoolean(portletPreferences.getValue("showneworther", null), true);
boolean enablestyledefaul = GetterUtil.getBoolean(portletPreferences.getValue("enablestyledefaul", null), false);
