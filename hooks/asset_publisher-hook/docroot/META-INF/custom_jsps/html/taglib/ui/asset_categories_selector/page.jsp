...
/* @HUYMQ: CHO TRUONG HOP CHON CATEGORIES CUA SITE KHAC */
long scopeId = GetterUtil.getLong(request.getAttribute("configuration.jsp-categorizableScopeId"));

Group siteGroup = themeDisplay.getSiteGroup();
if(scopeId > 0) {
	siteGroup = GroupLocalServiceUtil.getGroup(scopeId);
}
